...
>
  ...
  <xsl:variable name="bootstrap-heading-font-weight">300</xsl:variable>
  ...
  <!-- Accent -->
  <xsl:variable name="bootstrap-accent">#f066ba</xsl:variable>
  ...
  <xsl:variable name="bootstrap-accent-subtle">#fce0f1</xsl:variable>
    <xsl:variable name="bootstrap-accent-subtle-text">#60284a</xsl:variable>
  ...
  <xsl:variable name="bootstrap-card-border-color">#eeeeee</xsl:variable>
  ...
  <!-- Code colors -->
  <xsl:variable name="bootstrap-code-color">#da3e45</xsl:variable>
