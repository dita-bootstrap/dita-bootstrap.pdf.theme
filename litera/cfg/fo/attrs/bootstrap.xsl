...
>
  ...
  <xsl:variable name="bootstrap-primary-subtle">#e3ecfc</xsl:variable>
  <xsl:variable name="bootstrap-primary-subtle-text">#3768bd</xsl:variable>
  ...
  <!-- Secondary -->
  <xsl:variable name="bootstrap-secondary">#676b70</xsl:variable>
  ...
  <xsl:variable name="bootstrap-secondary-subtle">#e8e9ea</xsl:variable>
  <xsl:variable name="bootstrap-secondary-subtle-text">#62666a</xsl:variable>
  ...
  <xsl:variable name="bootstrap-success-subtle">#d9f4ea</xsl:variable>
  <xsl:variable name="bootstrap-success-subtle-text">#01784c</xsl:variable>
  ...
  <xsl:variable name="bootstrap-info-subtle">#dcf1f4</xsl:variable>
  <xsl:variable name="bootstrap-info-subtle-text">#107181</xsl:variable>
  ...
  <xsl:variable name="bootstrap-warning-subtle">#fdf3e4</xsl:variable>
  <xsl:variable name="bootstrap-warning-subtle-text">#90682f</xsl:variable>
  ...
  <xsl:variable name="bootstrap-danger-subtle">#f9e5e5</xsl:variable>
  <xsl:variable name="bootstrap-danger-subtle-text">#ae423f</xsl:variable>
  ...
  <!-- Accent -->
  <xsl:variable name="bootstrap-accent">#d96aec</xsl:variable>
  ...
  <xsl:variable name="bootstrap-accent-subtle">#f9e9fc</xsl:variable>
    <xsl:variable name="bootstrap-accent-subtle-text">#984aa5</xsl:variable>
  ...
  <xsl:variable name="bootstrap-inverse-subtle">#e1e1e2</xsl:variable>
  <xsl:variable name="bootstrap-inverse-subtle-text">#343a40</xsl:variable>
  ...
  <!-- Code colors -->
  <xsl:variable name="bootstrap-code-color">#ee487e</xsl:variable>
