...
>
  ...
  <!-- Secondary -->
  <xsl:variable name="bootstrap-secondary">#a6a6a6</xsl:variable>
  ...
  <!-- Accent -->
  <xsl:variable name="bootstrap-accent">#ff9dad</xsl:variable>
  ...
  <xsl:variable name="bootstrap-accent-subtle">#ffebee</xsl:variable>
    <xsl:variable name="bootstrap-accent-subtle-text">#663e45</xsl:variable>
  ...
  <!-- Code colors -->
  <xsl:variable name="bootstrap-code-color">#ff7e5e</xsl:variable>
